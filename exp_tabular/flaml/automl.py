...
class AutoML(BaseEstimator):
    ...
    def _prepare_data(self, eval_method, split_ratio, n_splits):
        ...
        if self._split_type == "group":
            ...
            if (
                ...
                self._state.kf = TimeSeriesSplit(n_splits=n_splits) # split mode
    ...
    def _decide_eval_method(self, eval_method, time_budget):
        ...
        if eval_method != "auto":
            assert eval_method in [
                ...
                "holdout_V2",
                "cv_V2",
            ], "eval_method must be 'holdout', 'cv', (tmp)'pseudo_cv', holdout_V2, cv_V2, or 'auto'."
            return eval_method
    ...
    def trainable(self) -> Callable[[dict], Optional[float]]:
        ...
        def train(config: dict, state):
            ...
            if self._state.eval_only is False:
                tune.report(**result)
                return result
            else:
                return result
